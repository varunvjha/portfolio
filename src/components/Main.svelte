...
<main class="flex flex-col flex-1 p-4">
  ...
  <section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
    <!-- <div class="flex flex-col gap-2 text-center">
      ...
      <a href="" target="_blank" class="mx-auto px-4 py-2 rounded-md border bolder-solid border-white flex item-center gap-2 -mb-4 sm:-mb-0 -mb-10 hover:border-violet-700 duration-200">
